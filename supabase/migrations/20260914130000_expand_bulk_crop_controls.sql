...
add constraint bulk_upload_items_display_crop_valid check (
  ...
  or (
    ...
    and (display_crop -> 'frame' ->> 'width')::numeric between 0.12 and 1
    and (display_crop -> 'frame' ->> 'height')::numeric between 0.12 and 1
    and (display_crop -> 'frame' ->> 'rotation')::numeric between -180 and 180
  )
);
