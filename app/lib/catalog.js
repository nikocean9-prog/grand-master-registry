...
export const tcgs = [
  ...
  {"slug": "grand-archive", "name": "Grand Archive", "initials": "GA", "status": "live", "description": "Track individually numbered Grand Archive cards by release.", "sets": [{"slug": "dawn-of-ashes-first-edition", "name": "Dawn of Ashes · First Edition CURs", "status": "live", "serials": 840, "summary": "12 serialised cards · 840 serial numbers", "description": "Track 12 serialised cards, each numbered to 70. Catalogue images are references; confirmed copies require photographic evidence.", "href": "/sets/dawn-of-ashes-first-edition"}, {"slug": "mercurial-heart-first-edition", "name": "Mercurial Heart · First Edition CUR", "status": "live", "serials": 72, "summary": "1 serialised card · 72 serial numbers", "description": "Track 1 serialised card(s), each numbered to 72. Catalogue images are references; confirmed copies require photographic evidence.", "href": "/sets/mercurial-heart-first-edition"}], "logo": "/graphics/grand-archive-logo-transparent-v2.webp"},
