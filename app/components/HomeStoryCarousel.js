    ...
    <section className="home-story-section" aria-labelledby="home-story-title">
      ...
      >
        ...
        <div className="home-story-copy">
          <p className="home-section-eyebrow">Cards with a story</p>
          <h2 id="home-story-title">{activeStory.title}</h2>
          <p>{activeStory.summary}</p>
          <Link href={activeStory.href} className="home-story-button">Read the full story</Link>
        </div>
      ...
      {stories.length > 1 && (
        <div className="home-story-dots" aria-label="Choose a card story">
